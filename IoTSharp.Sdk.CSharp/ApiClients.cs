            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false); 
                            var result_ = default(AttributeLatest); 
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<AttributeLatest>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                        ...
                        return default(AttributeLatest);
                    }
                    finally
                    {
                        if (response_ != null)
