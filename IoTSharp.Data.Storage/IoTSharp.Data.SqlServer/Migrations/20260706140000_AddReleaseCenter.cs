        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RollbackPackageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ConfirmationPolicy = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EdgeNodeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TargetKey = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    RuntimeType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ...
                    EdgeTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    CompletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastReceiptAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlanId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReleaseTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EdgeTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TargetType = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    TargetId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    GatewayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
