        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SemanticModelId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Version = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Enabled = table.Column<bool>(type: "bit", nullable: false),
                    ReportPolicy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CollectionTemplateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ConnectionKey = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ConnectionName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Transport = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    EndpointRef = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Host = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Port = table.Column<int>(type: "int", nullable: true),
                    SerialPort = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    AuthType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    TimeoutMs = table.Column<int>(type: "int", nullable: false),
                    RetryCount = table.Column<int>(type: "int", nullable: false),
                    ProtocolOptions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Metadata = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectionTemplateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ConnectionKey = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    PointKey = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    SemanticId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    BindingId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Name = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    DisplayName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    SourceType = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Address = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    FieldPath = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    RawValueType = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ...
                    Quantity = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Unit = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Enabled = table.Column<bool>(type: "bit", nullable: false),
                    ProtocolOptions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    QualityPolicy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Metadata = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CollectionTemplateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Protocol = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ProtocolKind = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportOnQualityChange = table.Column<bool>(type: "bit", nullable: false),
                    Subscription = table.Column<bool>(type: "bit", nullable: false),
                    AggregateHint = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Group = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PointTemplateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TransformType = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
