        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EdgeNodes_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EdgeNodes_Device_GatewayId",
                        column: x => x.GatewayId,
                        principalTable: "Device",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EdgeNodes_Tenant_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EdgeNodes_CustomerId",
                table: "EdgeNodes",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_EdgeNodes_CustomerId_TenantId_Deleted",
                table: "EdgeNodes",
                columns: new[] { "CustomerId", "TenantId", "Deleted" });

            migrationBuilder.CreateIndex(
                name: "IX_EdgeNodes_GatewayId",
                table: "EdgeNodes",
                column: "GatewayId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EdgeNodes_InstanceId",
                table: "EdgeNodes",
                column: "InstanceId");

            migrationBuilder.CreateIndex(
                name: "IX_EdgeNodes_RuntimeType_Status",
                table: "EdgeNodes",
                columns: new[] { "RuntimeType", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_EdgeNodes_TenantId",
                table: "EdgeNodes",
                column: "TenantId");
        }
