        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SemanticModelId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    Version = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Enabled = table.Column<bool>(type: "boolean", nullable: false),
                    ReportPolicy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CollectionTemplateId = table.Column<Guid>(type: "uuid", nullable: false),
                    ConnectionKey = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    ConnectionName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    Transport = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    EndpointRef = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    Host = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    Port = table.Column<int>(type: "integer", nullable: true),
                    SerialPort = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    AuthType = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    TimeoutMs = table.Column<int>(type: "integer", nullable: false),
                    RetryCount = table.Column<int>(type: "integer", nullable: false),
                    ProtocolOptions = table.Column<string>(type: "text", nullable: true),
                    Metadata = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollectionConnectionTemplates_CollectionTemplates_Collectio~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectionTemplateId = table.Column<Guid>(type: "uuid", nullable: false),
                    ConnectionKey = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    PointKey = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    SemanticId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    BindingId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    Name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    DisplayName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    SourceType = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    Address = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    FieldPath = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    RawValueType = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    ValueType = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Access = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Length = table.Column<int>(type: "integer", nullable: false),
                    Quantity = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    Unit = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    Enabled = table.Column<bool>(type: "boolean", nullable: false),
                    ProtocolOptions = table.Column<string>(type: "text", nullable: true),
                    QualityPolicy = table.Column<string>(type: "text", nullable: true),
                    Metadata = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollectionPointTemplates_CollectionTemplates_CollectionTemp~",
                        column: x => x.CollectionTemplateId,
                        principalTable: "CollectionTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProtocolKind = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollectionProtocolTemplates_CollectionTemplates_CollectionT~",
                        column: x => x.CollectionTemplateId,
                        principalTable: "CollectionTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PointTemplateId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollectionMappingPolicies_CollectionPointTemplates_PointTem~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AggregateHint = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    Group = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollectionSamplingPolicies_CollectionPointTemplates_PointTe~",
                        column: x => x.PointTemplateId,
                        principalTable: "CollectionPointTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    PointTemplateId = table.Column<Guid>(type: "uuid", nullable: false),
                    TransformType = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollectionTransformTemplates_CollectionPointTemplates_Point~",
                        column: x => x.PointTemplateId,
                        principalTable: "CollectionPointTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionConnectionTemplates_CollectionTemplateId_Connecti~",
