    ...
    <a-form ref="formRegister" :form="form" id="formRegister">
      ...
      <a-form-item>
        <a-input
          ...
          v-decorator="[
            'customerName',
            {
              rules: [{ required: true, type: 'string', message: $t('user.customerName.required') }],
              validateTrigger: ['change', 'blur'],
            },
          ]"
        >
      ...
      <a-form-item>
        <a-input
          size="large"
          type="text"
          :placeholder="$t('user.register.tenantName.placeholder')"
          v-decorator="[
            'tenantName',
            {
              rules: [{ required: true, type: 'string', message: $t('user.tenantName.required') }],
              validateTrigger: ['change', 'blur'],
            },
          ]"
        ></a-input>
      ...
      <a-form-item>
        <a-input
          size="large"
          type="text"
          :placeholder="$t('user.register.customerEMail.placeholder')"
          v-decorator="[
            'customerEMail',
            {
              rules: [{ required: true, type: 'email', message: $t('user.customerEMail.required') }],
              validateTrigger: ['change', 'blur'],
            },
          ]"
        ></a-input>
