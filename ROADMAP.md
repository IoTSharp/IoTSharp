...
目标：
- 🚧 RD-10.1 把 SonnetDB 作为 IoTSharp 的显式可选数据底座，而不是替换现有 PostgreSQL/MySQL/SQLServer/SQLite/Oracle/ClickHouse、InfluxDB/TimescaleDB/Taos/IoTDB、Redis/LiteDB/InMemory、BlobStorage/S3 路线。
