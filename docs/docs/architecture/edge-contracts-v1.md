...
| `collection-config-v1` | `EdgeCollectionConfigurationDto`、`EdgeCollectionConfigurationPullResultDto`、`EdgeCollectionAssignmentDto`、`CollectionTaskDto` | `IoTSharp.Contracts/collection-config.v1.schema.json` | `IoTSharp.Contracts/examples/collection-config.v1.sample.json` |
