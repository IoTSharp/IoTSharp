...
import { DeviceItem, EdgeItem, IBizData, IToolsPanel, PanelItem, PortItem } from 'src/app/models/devicegraph/ibizdata';
import { Device, GateWay } from 'src/app/models/devicegraph/shape';
...
export class DevicegraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.graph.on('edge:connected', ({ previousView, currentView, previousCell, currentCell, isNew, edge }) => {
      ...
      var g = sourcecell as unknown as Node;
      var d = targetcell as unknown as Node;
