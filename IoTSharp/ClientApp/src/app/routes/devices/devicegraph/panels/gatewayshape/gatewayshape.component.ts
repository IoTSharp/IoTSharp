...
import { STComponent, STColumnTag, STColumn, STData } from '@delon/abc/st';
import { Guid } from 'guid-typescript';
import { DeviceItem, IShapeData } from 'src/app/models/devicegraph/ibizdata';
import { GateWay } from 'src/app/models/devicegraph/shape';
...
export class GatewayshapeComponent implements OnInit {
  @ViewChild('st')
