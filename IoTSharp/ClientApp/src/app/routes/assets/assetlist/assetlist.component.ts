...
import { STPage, STReq, STRes, STComponent, STColumnTag, STColumn, STData, STChange } from '@delon/abc/st';
import { _HttpClient, ModalHelper, SettingsService } from '@delon/theme';
import { Guid } from 'guid-typescript';
import { NzDrawerService } from 'ng-zorro-antd/drawer';
import { NzMessageService } from 'ng-zorro-antd/message';
import { telemetryitem, attributeitem } from 'src/app/models/deviceitem';
      ...
      buttons: [
        {
          ...
          acl: 60,
          click: (item: any) => {
            this._router.navigateByUrl('iot/assets/assetentitylist?id=' + item.id);
          }
        },
        {
          text: '修改',
