...
namespace IoTSharp.TaskActions
{
    ...
    public class PublishAttributeDataTask : TaskAction
    {
        ...
        public override Task<TaskActionOutput> ExecuteAsync(TaskActionInput param)
        {
            ...
            try
            {
                var msg = new PlayloadData() { MsgBody = JsonNodeParser.ParseNode(param.Input)?.ToDictionary(), DataCatalog = DataCatalog.AttributeData, DataSide = DataSide.ClientSide, DeviceId = param.DeviceId };
