...
namespace IoTSharp.Data
{
    public class ApplicationDBInitializer
    {
        ...
        public async Task SeedDictionary()
        {
            ...
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "bool", DictionaryValue = "13", Dictionary18NKeyName = "dic.types.bool", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc ="" ,  DictionaryIcon = ""});
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "decimal[]", DictionaryValue = "12", Dictionary18NKeyName = "dic.types.decimalarray", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "datetime[]", DictionaryValue = "11", Dictionary18NKeyName = "dic.types.datetimearray", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "single数组", DictionaryValue = "10", Dictionary18NKeyName = "dic.types.singlearray", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "single", DictionaryValue = "9", Dictionary18NKeyName = "dic.types.single", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "double数组", DictionaryValue = "8", Dictionary18NKeyName = "dic.types.doublearray", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "string[]", DictionaryValue = "7", Dictionary18NKeyName = "dic.types.stringarray", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "int[]", DictionaryValue = "6", Dictionary18NKeyName = "dic.types.intarray", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            ...
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "DateTime", DictionaryValue = "5", Dictionary18NKeyName = "dic.types.DateTime", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "string", DictionaryValue = "4", Dictionary18NKeyName = "dic.types.string", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "decimal", DictionaryValue = "3", Dictionary18NKeyName = "dic.types.decimal", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "double", DictionaryValue = "2", Dictionary18NKeyName = "dic.types.double", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "int", DictionaryValue = "1", Dictionary18NKeyName = "dic.types.int", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });

            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "文件数组", DictionaryValue = "14", Dictionary18NKeyName = "dic.types.filearray", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "DateTimeOffset", DictionaryValue = "15", Dictionary18NKeyName = "dic.types.datetimeoffset", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
            this._context.BaseDictionaries.Add(new BaseDictionary { DictionaryName = "DateTimeOffset[]", DictionaryValue = "16", Dictionary18NKeyName = "dic.types.datetimeoffsetarray", DictionaryStatus = 1, DictionaryGroupId = datatype.Entity.DictionaryGroupId, DictionaryDesc = "", DictionaryIcon = "" });
